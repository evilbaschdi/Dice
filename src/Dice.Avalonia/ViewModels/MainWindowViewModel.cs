...
public class MainWindowViewModel : ViewModelBase
{
    ...
    ///     Gets or Sets the about window command.
    /// </summary>
    public ReactiveCommand<RxVoid, RxVoid> BrowseInitialDirectoryCommand { get; set; }

    /// <summary>
    ///     Gets or Sets the about window command.
    /// </summary>
    public ReactiveCommand<RxVoid, RxVoid> ThrowTheDiceCommand { get; set; }
    ...
    ///     Binding
    /// </summary>
    public string ThrowTheDiceResultPath
    {
        get;
        set => this.RaiseAndSetIfChanged(ref field, value);
    } = "roll the dice";
...
#pragma warning restore CA1826
    ...
    private async Task ThrowTheDiceCommandAction()
    {
        ...
        ThrowTheDiceResultPath = _rollTheDiceResultPath.Value;
    }
}